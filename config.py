...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "3994aad64b333549b348342077d5073f89cb9d17")
TUT_VID = os.environ.get("TUT_VID","https://t.me/how_to_download_moviezone/11")
...
ABOUT_TXT = "<b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/Ninadavydova1>Oᴡɴᴇʀ</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/Hantai_flixs>ғʟɪx ɴᴇᴛᴡᴏʀᴋ</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/Ninadavydova1>Nɪɴᴀ</a></blockquote></b>"
#--------------------------------------------
#--------------------------------------------
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @team_Luxe_Cultured</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
...
#Time and its price
#7 Days
PRICE1 = os.environ.get("PRICE1", "0 𝐓𝐊")
#1 Month
PRICE2 = os.environ.get("PRICE2", "60 𝐓𝐊")
#3 Month
PRICE3 = os.environ.get("PRICE3", "150 𝐓𝐊")
#6 Month
PRICE4 = os.environ.get("PRICE4", "280 𝐓𝐊")
#1 Year
PRICE5 = os.environ.get("PRICE5", "550 𝐓𝐊")
