...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            ...
            try:
                reload_url = (
                    f"https://hantaiflixs.vercel.app/"
                    if message.command and len(message.command) > 1
                    else None
                )
                keyboard = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("Mᴏʀᴇ Cʜᴀɴɴᴇʟ Lɪsᴛ!", url=reload_url)]]
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/Hanimevideo1")],
            ...
            if not await is_sub(client, user_id, chat_id):
                try:
                    ...
                    return await temp.edit(
                        f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @Ninadavydova1</i></b>\n"
